!function(t) {
    ...
    var n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = function(t) {
        ...
        return r;
    }(n), c = String.fromCharCode, u = function(t) {
    ...
    }, a = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g, i = function(t) {
        return t.replace(a, u);
    }, f = function(t) {
        var r = [ 0, 2, 1 ][t.length % 3], e = t.charCodeAt(0) << 16 | (t.length > 1 ? t.charCodeAt(1) : 0) << 8 | (t.length > 2 ? t.charCodeAt(2) : 0);
        return [ n.charAt(e >>> 18), n.charAt(e >>> 12 & 63), r >= 2 ? "=" : n.charAt(e >>> 6 & 63), r >= 1 ? "=" : n.charAt(63 & e) ].join("");
    }, d = t.btoa ? function(r) {
        return t.btoa(r);
    } : function(t) {
        return t.replace(/[\s\S]{1,3}/g, f);
    }, s = r ? r.from && r.from !== Uint8Array.from ? function(t) {
        return (t.constructor === r.constructor ? t : r.from(t)).toString("base64");
    } : function(t) {
        return (t.constructor === r.constructor ? t : new r(t)).toString("base64");
    } : function(t) {
        return d(i(t));
    }, h = function(t, r) {
        return r ? s(String(t)).replace(/[+\/]/g, function(t) {
            return "+" == t ? "-" : "_";
        }).replace(/=/g, "") : s(String(t));
    }, l = new RegExp([ "[À-ß][-¿]", "[à-ï][-¿]{2}", "[ð-÷][-¿]{3}" ].join("|"), "g"), g = function(t) {
        switch (t.length) {
          case 4:
        ...
        var r = t.length, e = r % 4, n = (r > 0 ? o[t.charAt(0)] << 18 : 0) | (r > 1 ? o[t.charAt(1)] << 12 : 0) | (r > 2 ? o[t.charAt(2)] << 6 : 0) | (r > 3 ? o[t.charAt(3)] : 0), u = [ c(n >>> 16), c(n >>> 8 & 255), c(255 & n) ];
        return u.length -= [ 0, 0, 2, 1 ][e], u.join("");
    }, b = t.atob ? function(r) {
        return t.atob(r);
    } : function(t) {
        return t.replace(/[\s\S]{1,4}/g, A);
    }, C = r ? r.from && r.from !== Uint8Array.from ? function(t) {
        return (t.constructor === r.constructor ? t : r.from(t, "base64")).toString();
    } : function(t) {
    ...
    if (t.Base64 = {
        ...
        t.Base64.extendString = function() {
            Object.defineProperty(String.prototype, "fromBase64", y(function() {
                return m(this);
            })), Object.defineProperty(String.prototype, "toBase64", y(function(t) {
                return h(this, t);
    ...
    t.Meteor && (Base64 = t.Base64), "undefined" != typeof module && module.exports ? module.exports.Base64 = t.Base64 : "function" == typeof define && define.amd && define([], function() {
        return t.Base64;
    });
